    ...
    <form onSubmit={handleSubmit} className="max-w-3xl space-y-8">
      ...
      <div className="flex items-center gap-3 pt-2 border-t border-white/[0.06]">
        <button
          type="submit"
          disabled={loading}
          className="px-5 py-2.5 bg-gradient-to-br from-indigo-400 to-pink-400 hover:from-indigo-300 hover:to-pink-300 disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-medium rounded-lg transition-all"
        >
