...
export default function AdminPtoRequestForm({ employees, defaultEmployeeId, action }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const result = await action({ employee_id: employeeId, start_date: startDate, end_date: endDate });
  ...
  const canSubmit = !loading && !!employeeId && preview !== null && preview > 0;
